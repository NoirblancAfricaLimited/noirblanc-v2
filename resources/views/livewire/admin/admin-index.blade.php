        ...
        <div class="card card-custom ">
            ...
            <div class="card-header border-0 py-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label font-weight-bolder text-dark">All Administrators</span>
                ...
                <div class="table-responsive">
                    <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_4">
                        ...
                        @forelse($admins as $admin)
                            <livewire:admin.admin-table-item :admin="$admin" :key="$admin->id"/>
                        @empty
                            <tr>
                                <td>
                                    <div class="alert alert-custom alert-outline-info fade show mb-5" role="alert">
                                        <div class="alert-icon"><i class="flaticon-warning"></i></div>
                                        <div class="alert-text">You currently have no admins</div>
