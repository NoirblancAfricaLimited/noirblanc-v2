        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <label>Price</label>
                        <input type="number" maxlength="10" class="form-control  form-control-solid"
...
{{--                                    <input id='service.open_at' class="form-control time-picker " type="text"--}}
{{--                                           wire:model.defer="service.open_at" readonly/>--}}
...
{{--                                <div class="input-group timepicker">--}}
{{--                                    <input id='service.close_at' class="form-control time-picker"  type="text"--}}
{{--                                           wire:model.defer="service.close_at" readonly/>--}}
{{--                                    <div class="input-group-append">--}}
{{--							<span class="input-group-text">--}}
{{--								<i class="la la-clock-o"></i>--}}
{{--							</span>--}}
