<div class="fullwidth-block features-section">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="feature">
                    <img src="{{asset('front')}}/images/icon-1.png" class="feature-image">
            ...
            <div class="col-md-3">
                <div class="feature">
                    <img src="{{asset('front')}}/images/icon-2.png" class="feature-image">
            ...
            <div class="col-md-3">
                <div class="feature">
                    <img src="{{asset('front')}}/images/icon-3.png" class="feature-image">
            ...
            <div class="col-md-3">
                <div class="feature">
                    <img src="{{asset('front')}}/images/icon-4.png" class="feature-image">
