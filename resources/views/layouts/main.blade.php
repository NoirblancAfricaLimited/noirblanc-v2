...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-row flex-column-fluid page  bg-white">
        ...
        <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
            <!--begin::Header-->
            <div id="kt_header" class="header flex-column  header-fixed bg-white">
                <!--begin::Top-->
                            ...
                            <div class="topbar-item">
                                <div
                                    ...
                                    <div class="d-flex flex-column text-right pr-lg-3">
                                        ...
                                        <span
                                            class="text-white font-weight-bolder font-size-sm d-none d-md-inline">{{auth()->user()->email}}</span>
                                    </div>
                                    <span class="symbol symbol-35">
									<span
                                        class="symbol-label font-size-h5 font-weight-bold text-white bg-white-o-30">{{auth()->user()->avatar}}</span>
								    </span>
                                </div>
                            </div>
                            <!--end::User-->
                    ...
                    <div class=" container ">
                        ...
                        <div class="header-navs header-navs-left" id="kt_header_navs">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane p-5 p-lg-0 justify-content-between" id="kt_header_tab_providers">
                                    <div id="kt_header_menu"
                                         class="header-menu header-menu-mobile  header-menu-layout-default ">
                                        <!--begin::Nav-->
                                        <ul class="menu-nav ">
                                            ...
                                            <li class="menu-item " aria-haspopup="true"><a
                                                    ...
                                                    class="menu-link "><span
                                                        class="menu-text">View</span></a></li>

                                            <li class="menu-item " aria-haspopup="true"><a
                                                    href="{{route('business.create')}}"
                                                    class="menu-link "><span
                                                        class="menu-text">Add</span></a></li>
                ...
                <div class=" container  d-flex flex-column flex-md-row align-items-center justify-content-between">
                    ...
                    <div class="text-dark order-2 order-md-1">
                        ...
                        <a href="http://keenthemes.com/metronic" target="_blank"
                           class="text-dark-75 text-hover-primary">smartified technology</a>
                    </div>
                    <!--end::Copyright-->
                    ...
                    <a href="#" class="navi-item">
                        <span class="navi-link p-0 pb-2">
                            <span class="navi-icon mr-1">
								<span
                                    class="svg-icon svg-icon-lg svg-icon-primary"><!--begin::Svg Icon | path:{{asset('')}}media/svg/icons/Communication/Mail-notification.svg-->
                ...
                <div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
                    ...
                    <div class="mb-5">
			            ...
			            <span class="svg-icon svg-icon-warning mr-5">
			                <span
                                class="svg-icon svg-icon-lg"><!--begin::Svg Icon | path:{{asset('')}}media/svg/icons/Home/Library.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                     width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <rect fill="#000000" opacity="0.3"
              ...
              x="16.3255682" y="2.94551858" width="3" height="18" rx="1"/>
			            ...
			            <span class="svg-icon svg-icon-success mr-5">
			                <span
                                class="svg-icon svg-icon-lg"><!--begin::Svg Icon | path:{{asset('')}}media/svg/icons/Communication/Write.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                     width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <path
            ...
            fill="#000000" fill-rule="nonzero" opacity="0.3"/>
			            ...
			            <span class="svg-icon svg-icon-danger mr-5">
			                <span
                                class="svg-icon svg-icon-lg"><!--begin::Svg Icon | path:{{asset('')}}media/svg/icons/Communication/Group-chat.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                     width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <path
            ...
            fill="#000000" opacity="0.3"/>
			            ...
			            <span class="svg-icon svg-icon-info mr-5">
			                <span
                                class="svg-icon svg-icon-lg"><!--begin::Svg Icon | path:{{asset('')}}media/svg/icons/General/Attachment2.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                     width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
                            ...
                            <div class="navi-link rounded">
                                <div class="symbol symbol-50 mr-3">
                                    <div class="symbol-label"><i
                                            class="flaticon-paper-plane-1 text-success icon-lg"></i>
                                    </div>
                                </div>
                                <div class="navi-text">
                                    <div class="font-weight-bold  font-size-lg">
                    ...
                    <div class="card-header align-items-center px-4 py-3">
                        <div class="text-left flex-grow-1">
                            ...
                            <div class="dropdown dropdown-inline">
                                ...
                                <span
                                    class="svg-icon svg-icon-lg"><!--begin::Svg Icon | path:{{asset('')}}media/svg/icons/Communication/Add-user.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                         width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <polygon points="0 0 24 0 24 24 0 24"/>
