...
<div class="dropdown">
    ...
    <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
        <div class="btn btn-icon btn-hover-transparent-white btn-dropdown btn-lg mr-1">
			        				<span
                                        class="svg-icon svg-icon-xl"><!--begin::Svg Icon | path:{{asset('')}}media/svg/icons/Media/Equalizer.svg-->
    ...
    <div
        ...
        <div class="row row-paddingless">
            ...
            <span
                class="svg-icon svg-icon-3x svg-icon-success"><!--begin::Svg Icon | path:{{asset('')}}media/svg/icons/Shopping/Euro.svg-->
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            <span
                class="svg-icon svg-icon-3x svg-icon-success"><!--begin::Svg Icon | path:{{asset('')}}media/svg/icons/Communication/Mail-attachment.svg-->
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                     height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <path
            ...
            <span
                class="svg-icon svg-icon-3x svg-icon-success"><!--begin::Svg Icon | path:{{asset('')}}media/svg/icons/Shopping/Box2.svg-->
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                     height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <path
            ...
            <span
                class="svg-icon svg-icon-3x svg-icon-success"><!--begin::Svg Icon | path:{{asset('')}}media/svg/icons/Communication/Group.svg-->
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                     height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
